  ...
  return (
    <>
      ...
      <div className="relative flex min-w-full shrink-0 flex-col gap-4 text-justify text-sm/6 font-normal text-taupe-800 dark:text-taupe-100">
        ...
        <p>
          Open to full-time and freelance work: remote, on-site, hybrid, doesn't
          matter. What matters is the work is worth doing.
        </p>
      ...
      <div className="relative flex min-w-full shrink-0 flex-col gap-4 text-justify text-sm/6 font-normal text-taupe-800 dark:text-taupe-100">
        <p>
          ...
          work under the hood. I care about the parts most people skip: how data
          moves, why system holds up under load, what happens when the happy
          path breaks. Data-intensive applications, API design, websockets, RPC,
          performance and scalability that's the work I actaully enjoy.
        </p>
        <p>
          ...
          have, and a real roadmap to get where they want to be. I came into it
          with zero finance background adn a lot of curiosity about why people's
          lives end up so differently even when everyone's earning something.
          Three months in. I've helped 15+ families make clearer decisions about
          their money. It's entirely on my own terms; no targets, no compulsion,
          just intent.
        </p>
        <p>
          ...
          for food distribution and beach cleanup drives with personalized group
